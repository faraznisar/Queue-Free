<%@ Page Title="" Language="C#" MasterPageFile="~/Student/Student.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Queue_Free.Student.Index" %>
            ...
            <div class="col-md-12 contentposition">
                ...
                <div class="col-md-12">
                    <div>
                        ...
                        <div class="col-md-3">
                            <div class="Division-Border"><img src="../Images/DSC_0143.JPG" class="Developer-Image" />
                                <p  style="text-align:center; color:white;">
                                    Gazala Mushtaq.<br />
