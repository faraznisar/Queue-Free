<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Queue_Free.Admin.Index" %>
                    ...
                    <div>
                        ...
                        <div class="col-md-3">
                            <div class="Division-Border">
                                ...
                                <img src="../Images/IMG-20180514-WA0000.jpg"  class="Developer-Image" />
                                <p  style="text-align:center; color:white;">
                                    Gazala Mushtaq.<br />
